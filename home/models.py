...
class PostModel(models.Model):
    ...
    postType = models.CharField(max_length=50,null=True)
    postStatus = models.CharField(max_length=50,null=True,default="Pending")
...
class ClaimOwner(models.Model):
    lostPostId = models.CharField(max_length=20)
    lostPostUserName = models.CharField(max_length=50)
    lostPostUserEmail = models.CharField(max_length=40)
    lostPostTittle = models.CharField(max_length=500,null=True)
    lostPostDescription = models.CharField(max_length=1000,null=True)
    lostPostUserId = models.CharField(max_length=20,null=True)
    lostPostImg = models.ImageField(upload_to=filepath, null=True, blank=True)

    foundPostId = models.CharField(max_length=20)
    foundPostUserName = models.CharField(max_length=50)
    foundPostUserEmail = models.CharField(max_length=40)
    foundPostTittle = models.CharField(max_length=500,null=True)
    foundPostDescription = models.CharField(max_length=1000,null=True)
    foundPostUserId = models.CharField(max_length=20,null=True)
    foundPostImg = models.ImageField(upload_to=filepath, null=True, blank=True)
